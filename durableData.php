...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <li class="nav-item">
                <a class="nav-link" href="durableForm.php">เพิ่มข้อมูลวัสดุคงทน</a>
            </li>
        </div>
    </nav>
    ...
    <table class="table table-bordered table-striped">
        ...
        <?php while($row = mysqli_fetch_assoc($result)){?>        
            <tr>
                ...
                <td>
                    <a href="deleteDurable.php?id=<?php echo $row["durable_id"]; ?>" 
                    class="btn btn-danger"
                    onclick="return confirm('คุณต้องการลบข้อมูลวัสดุคงทนนี้หรือไม่?')"
                    >ลบข้อมูล</a>
                </td>  
            </tr>
          <?php } ?>  
